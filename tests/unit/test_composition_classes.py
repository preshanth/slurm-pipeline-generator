...
from slurm_pipeline.core.components import CommandBuilder, ResourceConfig, FileManager, ScriptGenerator
...
class TestCommandBuilder:
    ...
    def test_python_command(self):
        ...
        command = cmd_builder.build_python_command("script.py", arg1="value1", arg2="value2")
