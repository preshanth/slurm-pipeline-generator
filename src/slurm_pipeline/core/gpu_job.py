...
class GPUJob(BaseJob):
    ...
    def get_gpu_job_config(self, job_name: str, memory_key: str,
                          walltime_key: Optional[str] = None) -> Dict[str, str]:
    ...
    def generate_gpu_job(self, job_name: str, memory_key: str, mode: Optional[str] = None,
