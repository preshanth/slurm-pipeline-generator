...
class PipelineDriver:
    ...
    def generate_all_scripts(self, dry_run: bool = True) -> Dict[str, List[Dict[str, Any]]]:
        """
    ...
    def _resolve_cross_application_dependencies(self):
        ...
        roadrunner_jobs = [name for name in self.job_scripts.keys() if 'roadrunner' in name]
