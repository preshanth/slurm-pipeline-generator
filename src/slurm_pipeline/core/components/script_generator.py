...
"""
    ...
    def generate_slurm_directives(self, job_config: Dict[str, str]) -> str:
        ...
        # Standard directives
        standard_keys = [
            'export', 'chdir', 'time', 'mem', 'nodes', 'ntasks_per_node',
            'output', 'error', 'job_name', 'account', 'mail_user', 'mail_type'
        ]
    ...
    def generate_script(self, job_config: Dict[str, str], command: List[str], 
                       environment_setup: str = "") -> str:
